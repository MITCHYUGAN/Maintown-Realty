...
import { 
  ...
  CheckCircle2, ChevronDown, MessageCircle, UserCheck, Video, ChevronRight 
} from 'lucide-react';
    ...
    <div className="pt-28 pb-24 bg-white text-slate-900 font-sans">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="max-w-3xl space-y-4 mb-16 text-left">
          ...
          <h1 className="font-sans text-3xl sm:text-4xl lg:text-5xl font-semibold text-slate-900 tracking-tight leading-[1.15]">
      ...
      <section className="py-20 bg-slate-50/60 border-y border-slate-200/80">
        <div className="max-w-5xl mx-auto px-6 md:px-12 lg:px-20 space-y-12">
          ...
          <div className="text-left space-y-2">
            <h2 className="font-sans text-2xl sm:text-3xl font-semibold text-slate-900 tracking-tight">
          ...
          <div className="space-y-5">
            {detailedSteps.map((item) => (
              ...
              >
                <div className="p-3 rounded-2xl bg-purple-50 border border-purple-100 shrink-0">
                  {item.icon}
                </div>

                <div className="space-y-2.5 flex-1">
                  <h3 className="font-sans text-lg sm:text-xl font-semibold text-slate-900">
                    {item.title}
                  </h3>
                  <p className="text-slate-800 font-medium text-sm sm:text-base">
                    "{item.shortCopy}"
                  </p>
                  <p className="text-slate-600 text-xs sm:text-sm leading-relaxed border-t border-slate-100 pt-3 font-normal">
                    {item.expandedCopy}
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white border border-slate-200/90 rounded-3xl overflow-hidden shadow-xs flex flex-col text-left">
              <div className="aspect-[16/10] w-full overflow-hidden bg-slate-100 relative">
                <img
                  src={nigerianMarketImg}
                  alt="Modern residence in Lagos, Nigeria"
              ...
              <div className="p-8 sm:p-9 space-y-4 flex-1 flex flex-col justify-between">
                <div className="space-y-3">
                  ...
                  <p className="text-slate-600 text-sm sm:text-base leading-relaxed font-normal">
                    We're starting in Lagos, where the problem is sharpest: inspection fees paid to strangers, listings that don't exist, and a full year's rent demanded upfront. We're building toward verified listings, inspections booked directly with the person who manages the property, and rent you can pay monthly. None of this is live yet — it's what we're building, and the waitlist is how you get there first.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-slate-200/90 rounded-3xl overflow-hidden shadow-xs flex flex-col text-left">
              <div className="aspect-[16/10] w-full overflow-hidden bg-slate-100 relative">
                <img
                  src={canadianMarketImg}
                  alt="Downtown Toronto condominium building in Canada"
                  referrerPolicy="no-referrer"
                  className="w-full h-full object-cover"
                />
              </div>
              ...
              <div className="p-8 sm:p-9 space-y-4 flex-1 flex flex-col justify-between">
                <div className="space-y-3">
                  <div className="flex items-center justify-between gap-3 flex-wrap">
                    ...
                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-medium bg-amber-50 text-amber-900 border border-amber-200 font-mono">
                      Coming Soon
                    </span>
                  </div>
                  <p className="text-slate-600 text-sm sm:text-base leading-relaxed font-normal">
                    Landing in a new country without somewhere safe to stay is its own kind of stress. We're actively building partnerships with licensed local Canadian partners to bring verified housing options to Nigerians before they fly, with the same checks we apply at home. This is future work — no Canadian listings exist on MainTown Realty today. Join the waitlist and we'll share updates with you first.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4 pt-2">
                <div className="flex items-start gap-3.5 p-4 rounded-2xl bg-slate-50/70 border border-slate-200/80">
                  ...
                  <p className="text-slate-700 text-sm sm:text-base leading-relaxed font-medium">
                    Listing photos are reverse-checked so they can't be lifted from another property or website.
                  </p>
                </div>
                ...
                <div className="flex items-start gap-3.5 p-4 rounded-2xl bg-slate-50/70 border border-slate-200/80">
                  ...
                  <p className="text-slate-700 text-sm sm:text-base leading-relaxed font-medium">
                    A video walkthrough is recorded for the property, so what you see is what exists.
                  </p>
                </div>
                ...
                <div className="flex items-start gap-3.5 p-4 rounded-2xl bg-slate-50/70 border border-slate-200/80">
                  ...
                  <p className="text-slate-700 text-sm sm:text-base leading-relaxed font-medium">
                    The landlord or agent's identity and right to let the property are confirmed before it goes live.
                  </p>
                </div>
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div
                key={index}
                id={`faq-item-${index}`}
                className="bg-white rounded-2xl border border-slate-200/90 shadow-xs overflow-hidden transition-all text-left"
              >
                <button
                  id={`faq-toggle-${index}`}
                ...
                {openFaq === index && (
                  <div className="px-6 pb-6 text-slate-600 text-sm sm:text-base leading-relaxed border-t border-slate-100 pt-4 font-normal">
                    {faq.answer}
                  </div>
                )}
              </div>
      ...
      <section className="py-20 md:py-24 bg-slate-950 text-white text-center border-t border-slate-900 relative overflow-hidden">
        <div className="max-w-3xl mx-auto px-6 md:px-12 space-y-6 relative z-10">
          ...
          <h3 className="font-sans text-2xl sm:text-3xl lg:text-4xl font-semibold text-white tracking-tight leading-tight">
