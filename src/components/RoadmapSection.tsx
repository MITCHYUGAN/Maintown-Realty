...
export default function RoadmapSection() {
  const availableNow = [
    'Browse listing previews & verified properties',
    'Contact us directly via WhatsApp for inquiries',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200/90 shadow-xs space-y-6 text-left relative overflow-hidden">
            <div className="flex items-center gap-2.5 pb-4 border-b border-slate-100">
              ...
              <span className="ml-auto text-xs font-medium bg-emerald-50 text-emerald-800 px-2.5 py-0.5 rounded-lg border border-emerald-200 font-mono">
                Live Prototype
              </span>
            </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200/90 shadow-xs space-y-6 text-left relative overflow-hidden">
            <div className="flex items-center gap-2.5 pb-4 border-b border-slate-100">
              ...
              <span className="ml-auto text-xs font-medium bg-amber-50 text-amber-900 px-2.5 py-0.5 rounded-lg border border-amber-200 font-mono">
                In Active R&D
              </span>
            </div>
